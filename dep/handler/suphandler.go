...
* 3.2) 关闭DataBox
*/
func (s *SupHandler) RecDemReqAndPushToSup(ctx *fasthttp.RequestCtx) {
...
*/
func (d *SupHandler) SupRespSendToDem(ctx *fasthttp.RequestCtx) {
 ...
 *test
 */
func (d *SupHandler) SupRespWholeSendToDem(ctx *fasthttp.RequestCtx) {
...
func (d *SupHandler) SupCompressFileSendToDem(ctx *fasthttp.RequestCtx) {
